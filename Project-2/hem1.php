  ...
  <div class="container">
    ...
    if(mysqli_num_rows($res)>0){
      while($images= mysqli_fetch_assoc($res))
     {
        ...
        <form method='post' action='like.php'> <button type='submit' name='submit' value='<?php echo $images['filename']; ?>' id="but"> Dislike</button></form>
...
?>
  ...
  <script>
    ...
    {
        let k=document.getElementById("but").value;
        if(k==1)
        {
