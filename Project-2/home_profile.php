...
<nav>
  ...
  <div class="container">
    ...
    $sql="SELECT * FROM `images` WHERE `uname`='$uid' ORDER BY `id` DESC";//************** */
    ...
    if(mysqli_num_rows($res)>0){
      while($images= mysqli_fetch_assoc($res))
     {
        ...
        <form method='post' action='like.php'> <button type='submit' name='submit' value='<?php echo $images['filename']; ?>'> Like</button></form>
